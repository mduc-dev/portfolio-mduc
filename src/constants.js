...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript these days.
    I've made a couple of games in that language. I also like Kotlin and SwiftUI. Anyway regardless of the language, I just like programming.
    Here is my <a href="https://github.com/mduc-dev" target="_blank">Github</a>!`,
  ...
  tv: `That's my TV. I've been watching tech youtubers a lot recently like :
   <a href="https://www.youtube.com/@wcandillon" target="_blank">Willian - wcandillon</a>,`,
  ...
  resume: `This is my desk and on it is my resume. <a href="https://github.com/mduc-dev/resume/blob/main/CV_NGUYEN%20MANH%20DUC.pdf" target="_blank">Check it out?</a>
  Contact me at duc040301@gmail.com and <a href="https://www.linkedin.com/in/mduc-dev" target="_blank">LinkedIn</a> if you have any interesting job opportunities!`,
  ...
  exit: `If you want to exit mduc-dev's portfolio, just close the tab.`,
};
